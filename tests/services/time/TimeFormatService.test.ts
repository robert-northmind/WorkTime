...
describe('TimeFormatService', () => {
  ...
  describe('getTimeInputValue', () => {
    ...
    it('returns undefined for null (Safari compatibility)', () => {
      expect(getTimeInputValue(null)).toBeUndefined();
    });

    it('returns undefined for undefined (Safari compatibility)', () => {
      expect(getTimeInputValue(undefined)).toBeUndefined();
    });

    it('returns undefined for empty string (Safari compatibility)', () => {
      expect(getTimeInputValue('')).toBeUndefined();
    });
  });
});
